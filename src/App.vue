<template>
  <div id="app" style="max-width:1400px;">
    ...
    <a href="https://github.com/CSSEGISandData/COVID-19" class="github-corner" aria-label="View source on GitHub">
        <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#3179bd; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
...
<script>
import CovTable from '@/components/CovTable.vue'
